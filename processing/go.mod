...
require (
	...
	code.emcdtech.com/emcd/service/accounting v1.2.102-0.20241128142159-db3d94988ca9
	code.emcdtech.com/emcd/service/coin v1.0.32
	code.emcdtech.com/emcd/service/profile v1.1.157
