module code.emcdtech.com/emcd/service/coin

go 1.23

require (
	code.emcdtech.com/emcd/blockchain/node v1.3.94
	code.emcdtech.com/emcd/sdk/app v1.2.3
	...
	code.emcdtech.com/emcd/services/rate v1.1.18
...
require (
	code.emcdtech.com/emcd/sdk/pg v1.0.5 // indirect
