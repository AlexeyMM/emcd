...
// Validate checks the field values on SettingsV2 with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *SettingsV2) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SettingsV2 with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in SettingsV2MultiError, or
// nil if none found.
func (m *SettingsV2) ValidateAll() error {
	return m.validate(true)
}

func (m *SettingsV2) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SettingsV2ValidationError{
					field:  "CreatedAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return SettingsV2ValidationError{
				field:  "CreatedAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return SettingsV2MultiError(errors)
	}

	return nil
}

// SettingsV2MultiError is an error wrapping multiple validation errors
// returned by SettingsV2.ValidateAll() if the designated constraints aren't met.
type SettingsV2MultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SettingsV2MultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SettingsV2MultiError) AllErrors() []error { return m }

// SettingsV2ValidationError is the validation error returned by
// SettingsV2.Validate if the designated constraints aren't met.
type SettingsV2ValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SettingsV2ValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SettingsV2ValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SettingsV2ValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SettingsV2ValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SettingsV2ValidationError) ErrorName() string { return "SettingsV2ValidationError" }

// Error satisfies the builtin error interface
func (e SettingsV2ValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = SettingsV2ValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SettingsV2ValidationError{}

// Validate checks the field values on GetV2Request with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *GetV2Request) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetV2Request with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in GetV2RequestMultiError, or
// nil if none found.
func (m *GetV2Request) ValidateAll() error {
	return m.validate(true)
}

func (m *GetV2Request) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetV2RequestMultiError(errors)
	}

	return nil
}

// GetV2RequestMultiError is an error wrapping multiple validation errors
// returned by GetV2Request.ValidateAll() if the designated constraints aren't met.
type GetV2RequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetV2RequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetV2RequestMultiError) AllErrors() []error { return m }

// GetV2RequestValidationError is the validation error returned by
// GetV2Request.Validate if the designated constraints aren't met.
type GetV2RequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetV2RequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetV2RequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetV2RequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetV2RequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetV2RequestValidationError) ErrorName() string { return "GetV2RequestValidationError" }

// Error satisfies the builtin error interface
func (e GetV2RequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = GetV2RequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetV2RequestValidationError{}

// Validate checks the field values on GetV2Response with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *GetV2Response) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetV2Response with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in GetV2ResponseMultiError, or
// nil if none found.
func (m *GetV2Response) ValidateAll() error {
	return m.validate(true)
}

func (m *GetV2Response) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetSettings() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetV2ResponseValidationError{
			...
			if err := v.Validate(); err != nil {
				return GetV2ResponseValidationError{
					field:  fmt.Sprintf("Settings[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetV2ResponseMultiError(errors)
	}

	return nil
}

// GetV2ResponseMultiError is an error wrapping multiple validation errors
// returned by GetV2Response.ValidateAll() if the designated constraints
// aren't met.
type GetV2ResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetV2ResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetV2ResponseMultiError) AllErrors() []error { return m }

// GetV2ResponseValidationError is the validation error returned by
// GetV2Response.Validate if the designated constraints aren't met.
type GetV2ResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetV2ResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetV2ResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetV2ResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetV2ResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetV2ResponseValidationError) ErrorName() string { return "GetV2ResponseValidationError" }

// Error satisfies the builtin error interface
func (e GetV2ResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = GetV2ResponseValidationError{}
