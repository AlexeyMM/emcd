...
const (
	...
	// P2PTransferFeeRef Комиссия в пользу рефовода за успешную p2p-сделку
	P2PTransferFeeRef TransactionType = 98
	// ProcessingInvoiceFee Комиссиия за проведенный платеж в сервисе процессинга
	ProcessingInvoiceFee TransactionType = 99
	...
	LastSupportedTransactionNumber = 99
)
